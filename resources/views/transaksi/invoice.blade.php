        ...
        <div class="card-header">
            <div class="row">
                <div class="col">
                    ...
                    <p>Nama Pelanggan : {{ $pelanggan ? $pelanggan->nama : 'Umum' }}</p>
                    <p>No. Telepon : {{ $pelanggan && $pelanggan->nomor_tlp ? $pelanggan->nomor_tlp : '-' }}</p>
                    <p>Alamat : {{ $pelanggan && $pelanggan->alamat ? $pelanggan->alamat : '-' }}</p>
                </div>
                <div class="col">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-6 offset-6 text-right">
                    <p>Sub Total : {{ number_format($detilPenjualan->sum('subtotal'), 0, ',', '.') }}</p>
