            ...
            <div class="card card-orange card-outline card-tabs">
                <div class="card-header p-0 pt-1 border-bottom-0">
                    <ul class="nav nav-tabs" id="cari-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="cari-produk-tab" data-toggle="pill" href="#cari-produk"
                                role="tab">
                                Cari Produk
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="cari-pelanggan-tab" data-toggle="pill" href="#cari-pelanggan"
                                role="tab">
                                Cari Pelanggan
                            </a>
                        </li>
